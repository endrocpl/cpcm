...
<body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">
        <div class="container">
            <h1 class="mt-5">Selamat Datang.., <?php echo $_SESSION["username"]; ?></h1>
            <p class="lead">Ini hasil test saya<code class="small"> semoga sesuai</code> </p>
